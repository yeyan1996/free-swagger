...
export const DEFAULT_HEAD_CODE_TS = `// generated by free-swagger ${EOL}// @ts-nocheck ${EOL}/* eslint-disable */${EOL}`;
export const DEFAULT_HEAD_CODE_JS = `// generated by free-swagger ${EOL}/* eslint-disable */${EOL}`;

const getDefaultConfig = (
    config: Config
): Required<Omit<Config, "source">> => ({
    root: (<any>global).__DEV__ ? path.resolve(__dirname, "../../test/api/pkg/default") : path.resolve(process.cwd(), "src/api"),
    cookie: "",
    customImportCode:
        config.lang === "ts"
